...
public final class CraftItemFactory implements ItemFactory {
    ...
    public boolean isApplicable(ItemMeta meta, Material type) {
        ...
        return true;//FIXME ((CraftMetaItem) meta).applicableTo(type);
    }
    ...
    private ItemMeta getItemMeta(Material material, CraftMetaItem meta) {//FIXME 
        /*switch (material) {
        case AIR:
            return null;
        case WRITTEN_BOOK:
    ...
    public boolean equals(ItemMeta meta1, ItemMeta meta2) {
        ...
        if (meta1 == null) {
            return false;//FIXME ((CraftMetaItem) meta2).isEmpty();
        }
        if (meta2 == null) {
            return false; //FIXME ((CraftMetaItem) meta1).isEmpty();
        }
    ...
    boolean equals(CraftMetaItem meta1, CraftMetaItem meta2) {
         ...
         */
        return false;//FIXME meta1.equalsCommon(meta2) && meta1.notUncommon(meta2) && meta2.notUncommon(meta1);
    }
